...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#25D366] text-white px-5 py-3 rounded-full font-bold text-sm shadow-xl transition-all duration-500 hover:scale-105 ${
        isVisible
          ? "opacity-100 translate-y-0 animate-[pulse_2.5s_infinite]"
